<?php
// $Id: NativeCalendar.php,v 1.2 2013/04/05 11:01:06 orynider Exp $
...
class NativeCalendar {
  ...
  function factory($id, $settings = NULL) {
	global $phpEx, $module_root_path;
    $filename = $module_root_path . 'includes/' . $id . 'Calendar.' . $phpEx;
  ...
  function factory_list() {
    ...
    $dir = opendir($module_root_path . 'includes/');
