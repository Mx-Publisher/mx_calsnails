...
* @version $Id: mx_announce.php,v 1.2 2009/10/08 17:59:30 orynider Exp $
...
// ===================================================
include_once($mx_root_path . 'mx_phpbb3blocksincludes/phpbb3blocks_constants.' . $phpEx);
...
$announce_nbr_display		= true;
$announce_nbr_days			= true;
$announce_display_global	= false;
$announce_display			= true;
$announce_display_sticky	= true;
$announce_display_normal	= false;
$announce_img_global		= 'thumb_globe.gif';
$announce_img				= 'thumb_globe.gif';
$announce_img_sticky		= 'thumb_globe.gif';
$announce_img_normal		= 'thumb_globe.gif';
$announce_forum				= 1;
...
for( $i = 0; $i < $total_posts; $i++ )
{
	...
	$bbcode_bitfield = $postrow[$i]['bbcode_bitfield'] ? $postrow[$i]['bbcode_bitfield'] : true;
